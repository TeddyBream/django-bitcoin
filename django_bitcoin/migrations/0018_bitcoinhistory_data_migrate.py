...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for wallet_transaction in orm.WalletTransaction.objects.all():
            bitcoin_history = orm.BitcoinHistory(created_at=wallet_transaction.created_at,
                                                 amount=wallet_transaction.amount,
                                                 id=wallet_transaction.id)
            bitcoin_history.save()
