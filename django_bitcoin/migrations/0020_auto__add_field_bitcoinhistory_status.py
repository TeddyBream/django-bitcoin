...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BitcoinHistory.status'
        db.add_column(u'django_bitcoin_bitcoinhistory', 'status',
                      self.gf('django.db.models.fields.CharField')(default='pending', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BitcoinHistory.status'
        db.delete_column(u'django_bitcoin_bitcoinhistory', 'status')
