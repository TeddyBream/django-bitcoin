...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('django_bitcoin_wallettransaction', 'id', 'bitcoinhistory_ptr_id')
        db.delete_column('django_bitcoin_wallettransaction', 'created_at')
        db.delete_column('django_bitcoin_wallettransaction', 'amount')
