...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WalletTransaction.wt_type'
        db.add_column(u'django_bitcoin_wallettransaction', 'wt_type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WalletTransaction.wt_type'
        db.delete_column(u'django_bitcoin_wallettransaction', 'wt_type')
