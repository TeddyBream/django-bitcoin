...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BitcoinHistory'
        db.create_table(u'django_bitcoin_bitcoinhistory', (
        ...
        db.send_create_signal(u'django_bitcoin', ['BitcoinHistory'])


    def backwards(self, orm):
        # Deleting model 'BitcoinHistory'
        db.delete_table(u'django_bitcoin_bitcoinhistory')
