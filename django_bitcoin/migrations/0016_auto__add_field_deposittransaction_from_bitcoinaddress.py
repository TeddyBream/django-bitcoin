...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DepositTransaction.from_bitcoinaddress'
        db.add_column(u'django_bitcoin_deposittransaction', 'from_bitcoinaddress',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DepositTransaction.from_bitcoinaddress'
        db.delete_column(u'django_bitcoin_deposittransaction', 'from_bitcoinaddress')
